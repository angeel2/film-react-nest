...
('0e33c7f6-27a7-4aa0-8e61-65d7e5effecf', 2.9, 'Итан Райт', ARRAY['Документальный'], 'Архитекторы общества', 
...
('51b4bc85-646d-47fc-b988-3e7051a9fe9e', 9.0, 'Харрисон Рид', ARRAY['Рекомендуемые'], 'Недостижимая утопия',
...
('3bedbc5a-844b-40eb-9d77-83b104e0cf75', 8.5, 'Элиза Уиттакер', ARRAY['Рекомендуемые'], 'Звёздное путешествие',
...
('0354a762-8928-427f-81d7-1656f717f39c', 9.5, 'Оливер Беннет', ARRAY['Рекомендуемые'], 'Парадокс Нексуса',
...
('92b8a2a7-ab6b-4fa9-915b-d27945865e39', 8.1, 'Амелия Хьюз', ARRAY['Рекомендуемые'], 'Сон в летний день',
